...
<script language="javascript" src="javascript/add_admission.js"></script>
  ...
  <tr class="lgbg">
    <td width="286"  align="right" class="fheader"><font style="font-size:12px"><b>name</b></font> </td>
    <td width="6" class="formfontcaps"><font face="Arial" size="+1">:</font></td>
    <td width="390"><input  type="text"  name="name" size="50" /></td>
  </tr>
 <tr class="lgbg">
    <td width="286"  align="right" class="fheader"><font style="font-size:12px"><b>standard</b></font> </td>
    <td width="6" class="formfontcaps"><font face="Arial" size="+1">:</font></td>
