...
?>						
		...
		<td bgcolor="#DDDDDD"><font face="verdana" style="font-size:12px"></font> <input type="image" src="images/update.gif" name="update" value="update"></td> 
...
<table width="95%"  border="0" cellspacing="2" cellpadding="1"> 
  <tr> 
    <td height="26" align="center" valign="bottom"><div align="center">&copy;Sahjanand vidhylay,Rajkot </div></td>
	</tr> 
</table> 
